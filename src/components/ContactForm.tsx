...
export default function ContactForm() {
  ...
  /**
   * Update local form state for controlled inputs.
   * Also clears a visible error once the user edits any field.
   *
  ...
  /**
   * Validate and submit the contact message to Supabase.
   *
